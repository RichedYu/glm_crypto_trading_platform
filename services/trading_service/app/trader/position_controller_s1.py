...
class PositionControllerS1:
    ...
    def __init__(self, trader_instance):
        ...
        self.s1_lookback = self.trader.settings.S1_LOOKBACK
        self.s1_sell_target_pct = self.trader.settings.S1_SELL_TARGET_PCT
        self.s1_buy_target_pct = self.trader.settings.S1_BUY_TARGET_PCT
